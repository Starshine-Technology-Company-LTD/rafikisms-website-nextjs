...
const features = landingContent.features.items;

/** Rounds SVG numeric props so SSR and client produce identical attribute strings (avoids hydration drift from float formatting). */
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="mb-10 lg:mb-14">
          <span className="inline-flex items-center gap-3 text-sm font-mono text-muted-foreground mb-6">
            ...
            {landingContent.features.eyebrow}
          </span>
          <h2
          ...
          >
            ...
            <br />
            <span className="text-muted-foreground">{landingContent.features.subtitle}</span>
          </h2>
        </div>
