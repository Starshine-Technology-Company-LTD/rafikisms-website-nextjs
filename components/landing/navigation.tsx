  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Logo */}
          <a href="#" className="flex items-center group" aria-label={landingContent.brand.name}>
            <Image
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Button
              size="sm"
              variant="ghost"
              className={`btn-brand rounded-full transition-all duration-500 ${isScrolled ? "px-4 h-8 text-xs" : "px-6"}`}
            >
